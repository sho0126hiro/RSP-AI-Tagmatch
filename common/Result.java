...
public class Result {
    ...
    /**
     * StatusEnumは分岐用 実際は勝利数（総獲得ポイント）で争うので，このEnumの勝利数（チーム全体としての勝利数）ではないので注意
     */
    ...
    public Result(int pointOfAllyAgentA, int pointOfAllyAgentB, int pointOfEnemyAgentA, int pointOfEnemyAgentB,
